// just slowly reformatting so features will be put in featues folder and ts can be more modular
...
async function backfillHistory() {
    ...
    // as long as the bot isnt dead for mor than 60 days should be fine
